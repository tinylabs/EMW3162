...
$(call RESOURCE_FILENAME, $(1)): $(1) $(STAGING_DIR).d | $(PLATFORM_PRE_BUILD_TARGETS) $(TEXT_TO_RES_SCRIPT) $(BIN_TO_RES_SCRIPT)
	...
	$(ECHO) $(CP) $(1) $(STAGING_DIR)$(notdir $(1))
...
ifeq (IAR,$(TOOLCHAIN_NAME))
	...
	$(CC) $(COMPILER_SPECIFIC_COMP_ONLY_FLAG) $(COMPILER_SPECIFIC_DEPS_FLAG) $(RESOURCE_CFLAGS) $(call ADD_COMPILER_SPECIFIC_STANDARD_CFLAGS, ) $($(1)_CFLAGS) -I$(SOURCE_ROOT)include/ -I$(SOURCE_ROOT)WICED/WWD/include -o $$@ $$<
	$(ECHO) $(CC) $(COMPILER_SPECIFIC_COMP_ONLY_FLAG) $(COMPILER_SPECIFIC_DEPS_FLAG) $(RESOURCE_CFLAGS) $(call ADD_COMPILER_SPECIFIC_STANDARD_CFLAGS, ) $($(1)_CFLAGS) -I$(SOURCE_ROOT)include/ -I$(SOURCE_ROOT)WICED/WWD/include -o $$@ $$<
endif
